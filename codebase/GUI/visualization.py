...
class Visualization(QtWidgets.QMainWindow):
    ...
    def __init__(self, svg, states, transitions, median_edge_count, parent=None):
        ...
        self.median_edge_count = median_edge_count
        ...
        self.classifying_slider_label = QtWidgets.QLabel()
        self.classifying_slider_label.setObjectName("Edge_Classifier")
        self.classifying_slider_label.setText("Edge Highliting")
        self.classifying_slider_label.setAlignment(QtCore.Qt.AlignCenter)
        vbox_classifying_slider.addWidget(self.classifying_slider_label)
        ...
        self.classifying_label.setText("성과 기준 Edge Coloring")
        ...
        self.wafer_selection_label.setText("Wafer Selection")
        ...
        vbox_selection.addWidget(self.wafer_selection_label)
        vbox_selection.addWidget(self.BOB_wafer_tableWidget)
        vbox_selection.addWidget(self.WOW_wafer_tableWidget)
        vbox_selection.addWidget(self.clear_push)
        ...
        vbox_main.addLayout(self.classifying_slider_label)
...
class Dummy_Slider_Widget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.lb.setText("BOB+WOW 비율 기준 Gray Coloring")
        self.lb.setAlignment(QtCore.Qt.AlignCenter)
    ...
    def handle_valueChanged(self):
        ...
        self.le.setText('dummy if dummy ratio > ' + str(self.dummy_threshold) + "%")
