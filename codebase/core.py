...
class Transitions(object):
    ...
    def __init__(self, step, source, dest, attr, trigger, count, BOB_count, WOW_count, status):
        """
        Args:
            source (string): The name of the source State.
            dest (string): The name of the destination State.
        ...
        self.count = count
        self.BOB_count = BOB_count
        self.WOW_count = WOW_count
        self.status = status
        self.step = step
...
class Machine(object):
    ...
    def add_transition(self, step, status, count, BOB_count, WOW_count, attr, trigger, source, dest, **kwargs):
        ...
        """
        self.trans.append(Transitions(step, source, dest, attr, trigger, count, BOB_count, WOW_count, status))
