...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtCore/sipQtCoreQElapsedTimer.cpp"
...
static sipEnumMemberDef enummembers_QElapsedTimer[] = {
    {sipName_MachAbsoluteTime, static_cast<int>( ::QElapsedTimer::MachAbsoluteTime), 54},
    {sipName_MonotonicClock, static_cast<int>( ::QElapsedTimer::MonotonicClock), 54},
    {sipName_PerformanceCounter, static_cast<int>( ::QElapsedTimer::PerformanceCounter), 54},
    {sipName_SystemTime, static_cast<int>( ::QElapsedTimer::SystemTime), 54},
    {sipName_TickCounter, static_cast<int>( ::QElapsedTimer::TickCounter), 54},
};
