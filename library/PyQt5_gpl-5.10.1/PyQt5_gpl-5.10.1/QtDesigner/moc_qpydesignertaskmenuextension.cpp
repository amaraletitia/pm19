...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPyDesignerTaskMenuExtension_t, stringdata0) + ofs \
...
void *QPyDesignerTaskMenuExtension::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPyDesignerTaskMenuExtension.stringdata0))
