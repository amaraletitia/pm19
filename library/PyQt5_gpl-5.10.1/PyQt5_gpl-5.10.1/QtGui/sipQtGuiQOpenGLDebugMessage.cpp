...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQOpenGLDebugMessage.cpp"
...
static sipEnumMemberDef enummembers_QOpenGLDebugMessage[] = {
    {sipName_APISource, static_cast<int>( ::QOpenGLDebugMessage::APISource), 137},
    {sipName_AnySeverity, static_cast<int>( ::QOpenGLDebugMessage::AnySeverity), 136},
    {sipName_AnySource, static_cast<int>( ::QOpenGLDebugMessage::AnySource), 137},
    {sipName_AnyType, static_cast<int>( ::QOpenGLDebugMessage::AnyType), 139},
    {sipName_ApplicationSource, static_cast<int>( ::QOpenGLDebugMessage::ApplicationSource), 137},
    {sipName_DeprecatedBehaviorType, static_cast<int>( ::QOpenGLDebugMessage::DeprecatedBehaviorType), 139},
    {sipName_ErrorType, static_cast<int>( ::QOpenGLDebugMessage::ErrorType), 139},
    {sipName_GroupPopType, static_cast<int>( ::QOpenGLDebugMessage::GroupPopType), 139},
    {sipName_GroupPushType, static_cast<int>( ::QOpenGLDebugMessage::GroupPushType), 139},
    {sipName_HighSeverity, static_cast<int>( ::QOpenGLDebugMessage::HighSeverity), 136},
    {sipName_InvalidSeverity, static_cast<int>( ::QOpenGLDebugMessage::InvalidSeverity), 136},
    {sipName_InvalidSource, static_cast<int>( ::QOpenGLDebugMessage::InvalidSource), 137},
    {sipName_InvalidType, static_cast<int>( ::QOpenGLDebugMessage::InvalidType), 139},
    {sipName_LowSeverity, static_cast<int>( ::QOpenGLDebugMessage::LowSeverity), 136},
    {sipName_MarkerType, static_cast<int>( ::QOpenGLDebugMessage::MarkerType), 139},
    {sipName_MediumSeverity, static_cast<int>( ::QOpenGLDebugMessage::MediumSeverity), 136},
    {sipName_NotificationSeverity, static_cast<int>( ::QOpenGLDebugMessage::NotificationSeverity), 136},
    {sipName_OtherSource, static_cast<int>( ::QOpenGLDebugMessage::OtherSource), 137},
    {sipName_OtherType, static_cast<int>( ::QOpenGLDebugMessage::OtherType), 139},
    {sipName_PerformanceType, static_cast<int>( ::QOpenGLDebugMessage::PerformanceType), 139},
    {sipName_PortabilityType, static_cast<int>( ::QOpenGLDebugMessage::PortabilityType), 139},
    {sipName_ShaderCompilerSource, static_cast<int>( ::QOpenGLDebugMessage::ShaderCompilerSource), 137},
    {sipName_ThirdPartySource, static_cast<int>( ::QOpenGLDebugMessage::ThirdPartySource), 137},
    {sipName_UndefinedBehaviorType, static_cast<int>( ::QOpenGLDebugMessage::UndefinedBehaviorType), 139},
    {sipName_WindowSystemSource, static_cast<int>( ::QOpenGLDebugMessage::WindowSystemSource), 137},
};
