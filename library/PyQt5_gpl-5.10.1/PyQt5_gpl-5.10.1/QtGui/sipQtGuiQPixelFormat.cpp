...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtGui/sipQtGuiQPixelFormat.cpp"
...
static sipEnumMemberDef enummembers_QPixelFormat[] = {
    {sipName_Alpha, static_cast<int>( ::QPixelFormat::Alpha), 224},
    {sipName_AtBeginning, static_cast<int>( ::QPixelFormat::AtBeginning), 220},
    {sipName_AtEnd, static_cast<int>( ::QPixelFormat::AtEnd), 220},
    {sipName_BGR, static_cast<int>( ::QPixelFormat::BGR), 224},
    {sipName_BigEndian, static_cast<int>( ::QPixelFormat::BigEndian), 223},
    {sipName_CMYK, static_cast<int>( ::QPixelFormat::CMYK), 224},
    {sipName_CurrentSystemEndian, static_cast<int>( ::QPixelFormat::CurrentSystemEndian), 223},
    {sipName_FloatingPoint, static_cast<int>( ::QPixelFormat::FloatingPoint), 225},
    {sipName_Grayscale, static_cast<int>( ::QPixelFormat::Grayscale), 224},
    {sipName_HSL, static_cast<int>( ::QPixelFormat::HSL), 224},
    {sipName_HSV, static_cast<int>( ::QPixelFormat::HSV), 224},
    {sipName_IMC1, static_cast<int>( ::QPixelFormat::IMC1), 226},
    {sipName_IMC2, static_cast<int>( ::QPixelFormat::IMC2), 226},
    {sipName_IMC3, static_cast<int>( ::QPixelFormat::IMC3), 226},
    {sipName_IMC4, static_cast<int>( ::QPixelFormat::IMC4), 226},
    {sipName_IgnoresAlpha, static_cast<int>( ::QPixelFormat::IgnoresAlpha), 222},
    {sipName_Indexed, static_cast<int>( ::QPixelFormat::Indexed), 224},
    {sipName_LittleEndian, static_cast<int>( ::QPixelFormat::LittleEndian), 223},
    {sipName_NV12, static_cast<int>( ::QPixelFormat::NV12), 226},
    {sipName_NV21, static_cast<int>( ::QPixelFormat::NV21), 226},
    {sipName_NotPremultiplied, static_cast<int>( ::QPixelFormat::NotPremultiplied), 221},
    {sipName_Premultiplied, static_cast<int>( ::QPixelFormat::Premultiplied), 221},
    {sipName_RGB, static_cast<int>( ::QPixelFormat::RGB), 224},
    {sipName_UYVY, static_cast<int>( ::QPixelFormat::UYVY), 226},
    {sipName_UnsignedByte, static_cast<int>( ::QPixelFormat::UnsignedByte), 225},
    {sipName_UnsignedInteger, static_cast<int>( ::QPixelFormat::UnsignedInteger), 225},
    {sipName_UnsignedShort, static_cast<int>( ::QPixelFormat::UnsignedShort), 225},
    {sipName_UsesAlpha, static_cast<int>( ::QPixelFormat::UsesAlpha), 222},
    {sipName_Y16, static_cast<int>( ::QPixelFormat::Y16), 226},
    {sipName_Y8, static_cast<int>( ::QPixelFormat::Y8), 226},
    {sipName_YUV, static_cast<int>( ::QPixelFormat::YUV), 224},
    {sipName_YUV411, static_cast<int>( ::QPixelFormat::YUV411), 226},
    {sipName_YUV420P, static_cast<int>( ::QPixelFormat::YUV420P), 226},
    {sipName_YUV420SP, static_cast<int>( ::QPixelFormat::YUV420SP), 226},
    {sipName_YUV422, static_cast<int>( ::QPixelFormat::YUV422), 226},
    {sipName_YUV444, static_cast<int>( ::QPixelFormat::YUV444), 226},
    {sipName_YUYV, static_cast<int>( ::QPixelFormat::YUYV), 226},
    {sipName_YV12, static_cast<int>( ::QPixelFormat::YV12), 226},
};
