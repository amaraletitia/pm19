...
#include <qcamera.h>
#line 31 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtMultimedia/sipQtMultimediaQCameraFrameRateRange.cpp"
...
extern "C" {static void assign_QCamera_FrameRateRange(void *, SIP_SSIZE_T, void *);}
static void assign_QCamera_FrameRateRange(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QCamera::FrameRateRange *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QCamera::FrameRateRange *>(sipSrc);
}
...
static pyqt5ClassPluginDef plugin_QCamera_FrameRateRange = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtMultimedia_QCamera_FrameRateRange = {
    {
        -1,
        0,
        0,
