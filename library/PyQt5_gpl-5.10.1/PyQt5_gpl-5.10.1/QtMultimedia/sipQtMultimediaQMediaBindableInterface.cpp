...
#line 26 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/sip/QtMultimedia/qmediabindableinterface.sip"
#include <qmediabindableinterface.h>
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtMultimedia/sipQtMultimediaQMediaBindableInterface.cpp"

#line 26 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/sip/QtMultimedia/qmediaobject.sip"
#include <qmediaobject.h>
#line 33 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtMultimedia/sipQtMultimediaQMediaBindableInterface.cpp"
...
PyDoc_STRVAR(doc_QMediaBindableInterface_mediaObject, "mediaObject(self) -> QMediaObject");
...
PyDoc_STRVAR(doc_QMediaBindableInterface_setMediaObject, "setMediaObject(self, QMediaObject) -> bool");

extern "C" {static PyObject *meth_QMediaBindableInterface_setMediaObject(PyObject *, PyObject *);}
static PyObject *meth_QMediaBindableInterface_setMediaObject(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    PyObject *sipOrigSelf = sipSelf;
    ...
    {
         ::QMediaObject* a0;
         ::QMediaBindableInterface *sipCpp;

        if (sipParseArgs(&sipParseErr, sipArgs, "pJ8", &sipSelf, sipType_QMediaBindableInterface, &sipCpp, sipType_QMediaObject, &a0))
        {
            bool sipRes;
            ...
            sipRes = sipCpp->setMediaObject(a0);
...
static void dealloc_QMediaBindableInterface(sipSimpleWrapper *sipSelf)
{
    ...
    {
        release_QMediaBindableInterface(sipGetAddress(sipSelf), sipIsDerivedClass(sipSelf));
    }
}
...
static PyMethodDef methods_QMediaBindableInterface[] = {
    ...
    {SIP_MLNAME_CAST(sipName_setMediaObject), meth_QMediaBindableInterface_setMediaObject, METH_VARARGS, SIP_MLDOC_CAST(doc_QMediaBindableInterface_setMediaObject)}
};
...
static pyqt5ClassPluginDef plugin_QMediaBindableInterface = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtMultimedia_QMediaBindableInterface = {
    {
        -1,
        0,
        0,
        ...
        {0},
        &plugin_QMediaBindableInterface
    },
    {
        sipNameNr_QMediaBindableInterface,
        {0, 0, 1},
