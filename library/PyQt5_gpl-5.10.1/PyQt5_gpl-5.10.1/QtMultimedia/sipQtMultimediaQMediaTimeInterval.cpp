...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtMultimedia/sipQtMultimediaQMediaTimeInterval.cpp"



PyDoc_STRVAR(doc_QMediaTimeInterval_start, "start(self) -> int");
...
PyDoc_STRVAR(doc_QMediaTimeInterval_end, "end(self) -> int");
...
PyDoc_STRVAR(doc_QMediaTimeInterval_contains, "contains(self, int) -> bool");
...
PyDoc_STRVAR(doc_QMediaTimeInterval_isNormal, "isNormal(self) -> bool");
...
PyDoc_STRVAR(doc_QMediaTimeInterval_normalized, "normalized(self) -> QMediaTimeInterval");
...
PyDoc_STRVAR(doc_QMediaTimeInterval_translated, "translated(self, int) -> QMediaTimeInterval");
...
extern "C" {static void assign_QMediaTimeInterval(void *, SIP_SSIZE_T, void *);}
static void assign_QMediaTimeInterval(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QMediaTimeInterval *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QMediaTimeInterval *>(sipSrc);
}
...
static pyqt5ClassPluginDef plugin_QMediaTimeInterval = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtMultimedia_QMediaTimeInterval = {
    {
        -1,
        0,
        0,
