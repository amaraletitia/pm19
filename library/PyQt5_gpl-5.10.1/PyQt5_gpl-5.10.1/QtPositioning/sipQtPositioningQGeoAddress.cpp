...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtPositioning/sipQtPositioningQGeoAddress.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtPositioning/sipQtPositioningQGeoAddress.cpp"


PyDoc_STRVAR(doc_QGeoAddress_text, "text(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setText, "setText(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_country, "country(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setCountry, "setCountry(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_countryCode, "countryCode(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setCountryCode, "setCountryCode(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_state, "state(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setState, "setState(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_county, "county(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setCounty, "setCounty(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_city, "city(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setCity, "setCity(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_district, "district(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setDistrict, "setDistrict(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_postalCode, "postalCode(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setPostalCode, "setPostalCode(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_street, "street(self) -> str");
...
PyDoc_STRVAR(doc_QGeoAddress_setStreet, "setStreet(self, str)");
...
PyDoc_STRVAR(doc_QGeoAddress_isEmpty, "isEmpty(self) -> bool");
...
PyDoc_STRVAR(doc_QGeoAddress_clear, "clear(self)");
...
PyDoc_STRVAR(doc_QGeoAddress_isTextGenerated, "isTextGenerated(self) -> bool");
...
extern "C" {static void assign_QGeoAddress(void *, SIP_SSIZE_T, void *);}
static void assign_QGeoAddress(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QGeoAddress *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QGeoAddress *>(sipSrc);
}
...
static pyqt5ClassPluginDef plugin_QGeoAddress = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtPositioning_QGeoAddress = {
    {
        -1,
        0,
        0,
