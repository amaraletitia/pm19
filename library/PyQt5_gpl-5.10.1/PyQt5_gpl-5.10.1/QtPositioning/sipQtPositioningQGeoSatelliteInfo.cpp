...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtPositioning/sipQtPositioningQGeoSatelliteInfo.cpp"



PyDoc_STRVAR(doc_QGeoSatelliteInfo_setSatelliteSystem, "setSatelliteSystem(self, QGeoSatelliteInfo.SatelliteSystem)");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_satelliteSystem, "satelliteSystem(self) -> QGeoSatelliteInfo.SatelliteSystem");
...
static PyObject *meth_QGeoSatelliteInfo_satelliteSystem(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QGeoSatelliteInfo, &sipCpp))
        {
            ...
            return sipConvertFromEnum(static_cast<int>(sipRes), sipType_QGeoSatelliteInfo_SatelliteSystem);
        }
    }
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_setSatelliteIdentifier, "setSatelliteIdentifier(self, int)");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_satelliteIdentifier, "satelliteIdentifier(self) -> int");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_setSignalStrength, "setSignalStrength(self, int)");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_signalStrength, "signalStrength(self) -> int");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_setAttribute, "setAttribute(self, QGeoSatelliteInfo.Attribute, float)");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_attribute, "attribute(self, QGeoSatelliteInfo.Attribute) -> float");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_removeAttribute, "removeAttribute(self, QGeoSatelliteInfo.Attribute)");
...
PyDoc_STRVAR(doc_QGeoSatelliteInfo_hasAttribute, "hasAttribute(self, QGeoSatelliteInfo.Attribute) -> bool");
...
extern "C" {static void assign_QGeoSatelliteInfo(void *, SIP_SSIZE_T, void *);}
static void assign_QGeoSatelliteInfo(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QGeoSatelliteInfo *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QGeoSatelliteInfo *>(sipSrc);
}
...
static pyqt5ClassPluginDef plugin_QGeoSatelliteInfo = {
    0,
    0,
    0,
    0
...
sipClassTypeDef sipTypeDef_QtPositioning_QGeoSatelliteInfo = {
    {
        -1,
        0,
        0,
