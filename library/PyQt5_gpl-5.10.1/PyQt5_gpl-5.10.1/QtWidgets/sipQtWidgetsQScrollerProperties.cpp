...
#line 29 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"

#line 26 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 33 "/Users/GYUNAM/Documents/PyProM/library/PyQt5_gpl-5.10.1/PyQt5_gpl-5.10.1/QtWidgets/sipQtWidgetsQScrollerProperties.cpp"
...
extern "C" {static void assign_QScrollerProperties(void *, SIP_SSIZE_T, void *);}
static void assign_QScrollerProperties(void *sipDst, SIP_SSIZE_T sipDstIdx, void *sipSrc)
{
...
static sipEnumMemberDef enummembers_QScrollerProperties[] = {
    {sipName_AcceleratingFlickMaximumTime, static_cast<int>( ::QScrollerProperties::AcceleratingFlickMaximumTime), 267},
    {sipName_AcceleratingFlickSpeedupFactor, static_cast<int>( ::QScrollerProperties::AcceleratingFlickSpeedupFactor), 267},
    {sipName_AxisLockThreshold, static_cast<int>( ::QScrollerProperties::AxisLockThreshold), 267},
    {sipName_DecelerationFactor, static_cast<int>( ::QScrollerProperties::DecelerationFactor), 267},
    {sipName_DragStartDistance, static_cast<int>( ::QScrollerProperties::DragStartDistance), 267},
    {sipName_DragVelocitySmoothingFactor, static_cast<int>( ::QScrollerProperties::DragVelocitySmoothingFactor), 267},
    {sipName_Fps20, static_cast<int>( ::QScrollerProperties::Fps20), 265},
    {sipName_Fps30, static_cast<int>( ::QScrollerProperties::Fps30), 265},
    {sipName_Fps60, static_cast<int>( ::QScrollerProperties::Fps60), 265},
    {sipName_FrameRate, static_cast<int>( ::QScrollerProperties::FrameRate), 267},
    {sipName_HorizontalOvershootPolicy, static_cast<int>( ::QScrollerProperties::HorizontalOvershootPolicy), 267},
    {sipName_MaximumClickThroughVelocity, static_cast<int>( ::QScrollerProperties::MaximumClickThroughVelocity), 267},
    {sipName_MaximumVelocity, static_cast<int>( ::QScrollerProperties::MaximumVelocity), 267},
    {sipName_MinimumVelocity, static_cast<int>( ::QScrollerProperties::MinimumVelocity), 267},
    {sipName_MousePressEventDelay, static_cast<int>( ::QScrollerProperties::MousePressEventDelay), 267},
    {sipName_OvershootAlwaysOff, static_cast<int>( ::QScrollerProperties::OvershootAlwaysOff), 266},
    {sipName_OvershootAlwaysOn, static_cast<int>( ::QScrollerProperties::OvershootAlwaysOn), 266},
    {sipName_OvershootDragDistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootDragDistanceFactor), 267},
    {sipName_OvershootDragResistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootDragResistanceFactor), 267},
    {sipName_OvershootScrollDistanceFactor, static_cast<int>( ::QScrollerProperties::OvershootScrollDistanceFactor), 267},
    {sipName_OvershootScrollTime, static_cast<int>( ::QScrollerProperties::OvershootScrollTime), 267},
    {sipName_OvershootWhenScrollable, static_cast<int>( ::QScrollerProperties::OvershootWhenScrollable), 266},
    {sipName_ScrollMetricCount, static_cast<int>( ::QScrollerProperties::ScrollMetricCount), 267},
    {sipName_ScrollingCurve, static_cast<int>( ::QScrollerProperties::ScrollingCurve), 267},
    {sipName_SnapPositionRatio, static_cast<int>( ::QScrollerProperties::SnapPositionRatio), 267},
    {sipName_SnapTime, static_cast<int>( ::QScrollerProperties::SnapTime), 267},
    {sipName_Standard, static_cast<int>( ::QScrollerProperties::Standard), 265},
    {sipName_VerticalOvershootPolicy, static_cast<int>( ::QScrollerProperties::VerticalOvershootPolicy), 267},
};
