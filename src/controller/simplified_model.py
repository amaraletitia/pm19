...
if __name__ == '__main__':
	eventlog = Eventlog.from_txt("/Users/GYUNAM/Documents/example/raw_data.txt")
	...
	result = stat_analyzer.produce_stat_analysis(0.0000001, 0.0000001)
	result.to_csv('../result/analysis_result.csv', sep = ',')
